...
def add(a: Frac, b: int | Frac) -> Frac: # 模拟分数的相加操作
...
def minus(a: Frac, b: int | Frac) -> Frac: # 模拟分数的相减操作
...
def times(a: Frac, b: int | Frac) -> Frac: # 模拟分数的相乘操作
...
def divide(a: Frac, b: int | Frac) -> Frac: # 模拟分数的相除操作
